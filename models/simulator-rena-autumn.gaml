...
global {
    ...
    action clear_dir {
    	bool delete_folder <- delete_file("../includes/output/rena/autumn");
    	file data <- new_folder("../includes/output/rena/autumn");
    }
}
    	...
    	ask simulations {
    		loop pig over: RenaPig {
    			save [
    				...
    				pig.cfi,
    				pig.weight
    			] to: "../includes/output/rena/autumn/" + experiment_id + "-" + string(pig.id) + ".csv" rewrite: false format: "csv";	
    		}
		}		
    }
